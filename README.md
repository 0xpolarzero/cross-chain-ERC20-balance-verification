- Cross-chain balance verification: Fetch data from other blockchain networks and bring it to the current network. This allows for token-gated access to smart contracts accross blockchains.
